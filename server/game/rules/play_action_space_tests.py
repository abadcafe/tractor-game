"""Black-box tests for the public follow action space."""
...
FollowActionSpace = play.FollowActionSpace
...
def build_follow_action_space(
    *,
    ...
    return play.build_follow_action_space(
        hand=hand,
...
def _semantic_traces(
    ...
    if isinstance(space.decode(prefix), Ok):
        return {prefix}
