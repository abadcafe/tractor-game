"""OpenAI-compatible Chat Completions client for the LLM agent."""
...
from server.game_agents.llm.client import (
    APIInteraction,
    ClientRejected,
    Decision,
    DecisionClient,
...
from server.game_agents.llm.config import LLMConfig
