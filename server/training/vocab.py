...
_FIELD_IDS: MappingProxyType[str, int] = MappingProxyType(
    {
        ...
        "round:self_team_level": 15,
        "round:enemy_team_level": 16,
        "round:self_team_required_level": 17,
        "round:self_team_distance_to_required_level": 18,
        "round:enemy_team_distance_to_required_level": 19,
        "round:trump_suit": 20,
        "round:level_rank": 21,
        "round:level_card_revealer_role": 22,
        "round:current_score": 23,
        "round:remaining_cards_self": 24,
        "round:remaining_cards_partner": 25,
        "round:remaining_cards_left_enemy": 26,
        "round:remaining_cards_right_enemy": 27,
        "round:winning_team": 28,
