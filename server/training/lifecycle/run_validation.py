...
def validate_training_run(
    ...
    for path in manifest_paths:
        ...
        training_metadata_result = read_training_checkpoint_metadata(
            path
        )
        if isinstance(training_metadata_result, _result.Rejected):
            return training_metadata_result
        training_metadata = training_metadata_result.value
        loaded = load_training_checkpoint(
            path=path,
            model_config=training_metadata.model_config,
            train_config=training_metadata.train_config,
