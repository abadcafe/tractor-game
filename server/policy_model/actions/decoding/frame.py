...
from server.policy_model._schema.actions import MAX_ACTION_STEPS
from server.policy_model.actions.decoding.compile import (
...
def compile_legal_action_frame(
    ...
    """Compile one legal action space into a flat runtime frame."""
