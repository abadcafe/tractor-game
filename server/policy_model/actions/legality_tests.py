"""Tests for rule-complete semantic legal action spaces."""
...
def test_build_legal_action_space_ignores_action_hints_for_follow() -> (
    None
):
...
def _sampled_first_choice_id(
    *, legal_actions: LegalActionSpace, target_choice_id: int
) -> int:
